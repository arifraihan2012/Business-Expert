...
Public Class RptPurchaseInvoice
    ...
    Private Sub RptPurchaseInvoice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub ShowInvoice()
        ...
        Try
            ...
            cryRpt.Load("" + FrmHome.ReportLocation + "" & "PurchaseInvoice.rpt")
            ...
            cryRpt.SetParameterValue("SupplierPurchaseInvoiceNo", PurchaseInvoiceNo)
