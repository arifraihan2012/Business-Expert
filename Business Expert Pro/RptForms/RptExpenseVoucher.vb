...
Public Class RptExpenseVoucher
    Public InvoiceNo As String
    Private Sub RptExpenseVoucher_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ShowExpenseVoucherInvoice()
    End Sub
    Sub ShowExpenseVoucherInvoice()
        ...
        Try
            ...
            cryRpt.Load("" + FrmHome.ReportLocation + "" & "ExpenseVoucher.rpt")
