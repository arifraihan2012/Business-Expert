...
Public Class RptSaleReturnInvoice
    Public SaleReturnInvoiceNo As String
    Public SaleInvoiceNo As String

    Private Sub RptSaleReturnInvoice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ShowInvoice()
    ...
    Sub ShowInvoice()
        ...
        Try
            ...
            cryRpt.Load("" + FrmHome.ReportLocation + "" & "SaleReturnInvoice.rpt")
            ...
            cryRpt.SetParameterValue("SaleReturnInvoiceNo", SaleReturnInvoiceNo)
