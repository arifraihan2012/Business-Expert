...
Public Class RptReceitpVoucher
    Public InvoiceNo As String
    Private Sub RptReceitpVoucher_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ShowVoucherInvoice()
    End Sub
    ...
    Sub ShowVoucherInvoice()
        ...
        Try
            ...
            cryRpt.Load("" + FrmHome.ReportLocation + "" & "Receiptvoucher.rpt")
