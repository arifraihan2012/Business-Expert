...
Public Class RptPOSSaleInvoice
    Public SaleInvoiceNo As String

    Private Sub RptPOSSaleInvoice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub ShowSaleInvoice()
        ...
        Try
            ...
            cryRpt.PrintOptions.PrinterName = "Xpert Printer"
