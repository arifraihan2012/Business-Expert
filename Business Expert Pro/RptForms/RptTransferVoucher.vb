...
Public Class RptTransferVoucher
    Public InvoiceNo As String

    Private Sub RptTransferVoucher_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Show Transfer Voucher Invoice
        ShowTransferVoucherInvoice()

    End Sub
    Sub ShowTransferVoucherInvoice()
        ...
        Try
            ...
            cryRpt.Load("" + FrmHome.ReportLocation + "" & "TransferVoucher.rpt")
