...
Imports System.IO
Public Class FrmListofCustomers
    ...
    Sub RefreshData()
        Try
            ...
            Dim sql As String = "SELECT [Customer ID],[Customer Name],[Company Name],[Designation],[Mobile No] FROM [Customer Information]"
            ...
            GrdListofCustomers.DataMember = "BizPro_Customer Information"
    ...
    Private Sub TxtSearchCustomerName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtSearchCustomerName.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            Try
                ...
                If Label1.Text = "Customer Ledger" Then
                    FrmOldLedger.CmbCustomerID.ValueMember = GrdListofCustomers.Item(0, i).Value
                    FrmOldLedger.CmbCustomerID.Text = GrdListofCustomers.Item(1, i).Value
                    FrmOldLedger.FocusOnPaymentOrReceiveTextBox()
                    FrmOldLedger.RefreshData()
                    Me.Close()

                ElseIf Label1.Text = "Search Customer" Then
                    FrmOldLedger.cmbSearchName.ValueMember = GrdListofCustomers.Item(0, i).Value
                    FrmOldLedger.cmbSearchName.Text = GrdListofCustomers.Item(1, i).Value
                    FrmOldLedger.SearchCustomer()
                    Me.Close()


                ElseIf Label1.Text = "Sale" Then

                    FrmSale.CmbCustomerName.ValueMember = GrdListofCustomers.Item(0, i).Value
                    FrmSale.CmbCustomerName.Text = GrdListofCustomers.Item(1, i).Value
                    FrmSale.cmbProductName.Focus()
                    FrmSale.customerInformation()
                    FrmSale.ShowDueOrAdvance()
                    FrmSale.NetPayableAmount()
                    Me.Close()

                ElseIf Label1.Text = "Chalan" Then

                    FrmChalan.CmbCustomerName.ValueMember = GrdListofCustomers.Item(0, i).Value
                    FrmChalan.CmbCustomerName.Text = GrdListofCustomers.Item(1, i).Value
                    FrmChalan.cmbProductName.Focus()
                    FrmChalan.customerInformation()
                    FrmChalan.NetPayableAmount()
                    Me.Close()

                ElseIf Label1.Text = "Quotation" Then

                    FrmQuotation.CmbCustomerName.ValueMember = GrdListofCustomers.Item(0, i).Value
                    FrmQuotation.CmbCustomerName.Text = GrdListofCustomers.Item(1, i).Value
                    FrmQuotation.cmbProductName.Focus()
                    FrmQuotation.customerInformation()
                    FrmQuotation.TotalAmountPayable()
                    Me.Close()
                End If
    ...
    Private Sub TxtSearchCustomerName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtSearchCustomerName.TextChanged
        ...
        Try
            ...
            Dim connectionString As String = FrmHome.ConnectionString
            Dim sql As String = "SELECT [Customer ID],[Customer Name],[Company Name],[Designation],[Mobile No] FROM [Customer Information]  WHERE ([Customer Name] LIKE '%" + Me.TxtSearchCustomerName.Text + "%')"
