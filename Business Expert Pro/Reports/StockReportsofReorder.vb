...
Public Class StockReportsofReorder
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StockReportsofReorder.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.StockReportsofReorder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockReportsofReorder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockReportsofReorder = New StockReportsofReorder
        rpt.Site = Me.Site
        Return rpt
    End Function
