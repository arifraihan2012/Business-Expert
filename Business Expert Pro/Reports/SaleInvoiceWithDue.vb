...
Public Class SaleInvoiceWithDue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.SaleInvoiceWithDue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleInvoiceWithDue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleInvoiceWithDue = New SaleInvoiceWithDue
        rpt.Site = Me.Site
        Return rpt
    End Function
