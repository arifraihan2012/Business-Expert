...
Public Class BarcodePrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.BarcodePrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NumberToPrint() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBarcodePrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BarcodePrint = New BarcodePrint
        rpt.Site = Me.Site
        Return rpt
    End Function
