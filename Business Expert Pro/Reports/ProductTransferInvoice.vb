...
Public Class ProductTransferInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ProductTransferInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.ProductTransferInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TransferInvoiceNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedProductTransferInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProductTransferInvoice = New ProductTransferInvoice
        rpt.Site = Me.Site
        Return rpt
    End Function
