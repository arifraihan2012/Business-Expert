...
Public Class CashFlowReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.CashFlowReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Branch_ID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCashFlowReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CashFlowReport = New CashFlowReport
        rpt.Site = Me.Site
        Return rpt
    End Function
