...
Public Class PurchaseReturnInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PurchaseReturnInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.PurchaseReturnInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PurchaseReturnInvoiceNo() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_product_details_PurchaseInvoiceNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPurchaseReturnInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseReturnInvoice = New PurchaseReturnInvoice
        rpt.Site = Me.Site
        Return rpt
    End Function
