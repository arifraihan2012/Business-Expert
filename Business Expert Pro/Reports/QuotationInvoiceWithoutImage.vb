...
Public Class QuotationInvoiceWithoutImage
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "QuotationInvoiceWithoutImage.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.QuotationInvoiceWithoutImage.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_QuotationInvoiceNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedQuotationInvoiceWithoutImage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QuotationInvoiceWithoutImage = New QuotationInvoiceWithoutImage
        rpt.Site = Me.Site
        Return rpt
    End Function
