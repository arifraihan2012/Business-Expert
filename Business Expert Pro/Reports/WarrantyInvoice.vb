...
Public Class WarrantyInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Business_Expert_Pro.WarrantyInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WarrantyInvoiceNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedWarrantyInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WarrantyInvoice = New WarrantyInvoice
        rpt.Site = Me.Site
        Return rpt
    End Function
